...
Trong những bài trước của series **Thử Nghiệm Với Angular 2** mình đã giới thiệu một số <a href="https://angular.io/docs/ts/latest/guide/structural-directives.html" target="_blank" rel="noopener noreferrer">Structual Directives</a> và hướng dẫn <a href="/thu-nghiem-voi-angular-2-style-component-view-encapsulation/" target="_blank" rel="noopener noreferrer">Style cho Component, View Encapsulation</a>. Trong bài học này, chúng ta sẽ tìm hiểu về những Attribute Directives như <a href="https://angular.io/docs/ts/latest/guide/template-syntax.html#!#ngStyle" target="_blank" rel="noopener noreferrer">NgStyle</a>, <a href="https://angular.io/docs/ts/latest/guide/template-syntax.html#!#ngClass" target="_blank" rel="noopener noreferrer">NgClass </a>và property binding cho class, style.
...
<a href="https://angular.io/docs/ts/latest/guide/template-syntax.html#!#ngStyle" target="_blank" rel="noopener noreferrer">NgStyle</a>

<a href="https://angular.io/docs/ts/latest/guide/template-syntax.html#!#ngClass" target="_blank" rel="noopener noreferrer">NgClass </a>
