...
description: 'Angular 2 đã phát hành chính thức, hầu hết các blog đều có những lời đánh tiếng về nó và cũng có vô vàn các hướng dẫn để bạn có thể tiếp cận với Angular 2. Vậy bạn đã sẵn sàng để bắt đầu với nền tảng hot này chưa?'
...
Các bạn tải về phần cài đặt cho <a href="https://nodejs.org/en/download/" target="_blank" rel="noopener noreferrer">Nodejs tại đây</a>, mình ưu tiên sử dụng bản 6 trở lên và dùng bản LTS. Các bạn tải về và cài đặt theo hệ điều hành đang sử dụng.
...
Các bạn có thể sử dụng &#8220;<a href="https://github.com/angular/quickstart" target="_blank" rel="noopener noreferrer">Quick start</a>&#8221; hoặc &#8220;<a href="https://github.com/angular/angular2-seed" target="_blank" rel="noopener noreferrer">Angular 2 seed</a>&#8221; nếu muốn, các phần code cũng sẽ giống nhau. Mình sẽ sử dụng Angular CLI.
...
– Version Control System: <a href="https://git-scm.com/" target="_blank" rel="noopener noreferrer">Git</a> (không bắt buộc)
...
Các bạn có thể dùng bất cứ editor nào mình thích và quen thuộc để làm việc, mình có một số gợi ý: <a href="https://code.visualstudio.com/" target="_blank" rel="noopener noreferrer">Visual Studio Code</a>, <a href="https://www.sublimetext.com/" target="_blank" rel="noopener noreferrer">Sublime Text</a>, <a href="https://atom.io/" target="_blank" rel="noopener noreferrer">Atom</a>, thậm chí <a href="http://www.vim.org/" target="_blank" rel="noopener noreferrer">Vim</a>.
...
<Figure
  className="post-figure"
  src="@public/assets/uploads/2016/12/1-project-structure.png"
  alt="Angular project structure"
  width="608"
  height="860"
  caption="Hình 2: Project structure"
/>
...
<Figure
  className="post-figure"
  src="@public/assets/uploads/2016/12/3-at-component.png"
  alt="Angular Decorator @Component"
  width="1104"
  height="585"
  caption="Hình 4: `@Component`"
/>
...
<Figure
  className="post-figure"
  src="@public/assets/uploads/2016/12/app-root.png"
  alt="Angular Component selector app-root"
  width="935"
  height="367"
  caption="Hình 5: Custom tag `<app-root>` – selector"
/>
...
<Figure
  className="post-figure"
  src="@public/assets/uploads/2016/12/templateUrl.png"
  alt="Angular Component templateUrl"
  width="460"
  height="280"
  caption="Hình 6: templateUrl content"
/>

<Figure
  className="post-figure"
  src="@public/assets/uploads/2016/12/template.png"
  alt="Angular Component inline template"
  width="530"
  height="300"
  caption="Hình 7: inline template content"
/>
...
Định nghĩa class tên là `AppComponent`, với property `title` sau đó export cho module khác sử dụng, đây là tính năng <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Statements/export" target="_blank" rel="noopener noreferrer">module export</a> và <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Statements/class" target="_blank" rel="noopener noreferrer">class</a> trong ES2015.

**Chúng ta vừa hoàn thành duyệt qua một vòng về Component, vậy làm gì tiếp theo đây?**

Câu trả lời là <a href="https://angular.io/docs/ts/latest/guide/ngmodule.html" target="_blank" rel="noopener noreferrer">Angular Module</a> hay NgModule.
...
<Figure
  className="post-figure"
  src="@public/assets/uploads/2016/12/NgModule-root-Module-1.png"
  alt="Angular NgModule root Module"
  width="900"
  height="460"
  caption="Hình 8: `AppModule` – root Module"
/>
...
Ngoài ra còn có **`exports` array** là list các component mà Module này trả về cho Module khác. Các bạn có thể xem thêm về <a href="https://angular.io/docs/ts/latest/guide/architecture.html" target="_blank" rel="noopener noreferrer">kiến trúc của Angular tại đây</a>.
...
<Figure
  className="post-figure"
  src="@public/assets/uploads/2016/12/main-1.png"
  alt="Angular 2 main file"
  width="1104"
  height="746"
  caption="Hình 9: `main.ts`"
/>
...
<Figure
  className="post-figure"
  src="@public/assets/uploads/2016/12/ng-serve.png"
  alt="ng serve command"
  width="580"
  height="320"
  caption="Hình 10: ng serve"
/>


Sau đó, các bạn mở trình duyệt vào truy cập vào địa chỉ <a href="http://localhost:4200/" target="_blank" rel="noopener noreferrer">http://localhost:4200/</a>. Kết quả có dạng như sau.

<Figure
  className="post-figure"
  src="@public/assets/uploads/2016/12/first-app.png"
  alt="first Angular app"
  width="960"
  height="530"
  caption="Hình 11: first app"
/>
...
<Figure
  className="post-figure"
  src="@public/assets/uploads/2016/12/change-app-component.png"
  alt="Edit AppComponent"
  width="730"
  height="275"
  caption="Hình 12: edit AppComponent"
/>

<Figure
  className="post-figure"
  src="@public/assets/uploads/2016/12/result.png"
  alt="result"
  width="960"
  height="530"
  caption="Hình 13: result"
/>
