...
* <a href="https://yarnpkg.com/en/docs/install" target="_blank" rel="noopener noreferrer">Yarn Package Manager (Optional)</a>
...
<Youtube id="SXW-Nz-lp70"/>

## Tham khảo
Ahead-of-time compilation: <a href="https://angular.io/guide/aot-compiler" target="_blank" rel="noopener noreferrer">{'https://angular.io/guide/aot-compiler'}</a>
