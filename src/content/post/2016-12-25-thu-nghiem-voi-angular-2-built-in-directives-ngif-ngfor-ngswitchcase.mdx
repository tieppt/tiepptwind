...
> Lưu ý: để sử dụng các directives này, bạn cần import <a href="https://angular.io/docs/ts/latest/api/platform-browser/index/BrowserModule-class.html" rel="noopener noreferrer" target="_blank" rel="noopener noreferrer">BrowserModule</a> hoặc <a href="https://angular.io/docs/ts/latest/api/common/index/CommonModule-class.html" rel="noopener noreferrer" target="_blank" rel="noopener noreferrer">CommonModule</a>
...
<Youtube id="KxvyaY2OY6s" />

## Tham khảo

`*ngIf`: <a href="https://angular.io/docs/ts/latest/guide/template-syntax.html#ngIf" target="_blank" rel="noopener noreferrer">https://angular.io/docs/ts/latest/guide/template-syntax.html#ngIf</a>

`*ngFor`: <a href="https://angular.io/docs/ts/latest/guide/template-syntax.html#ngFor" target="_blank" rel="noopener noreferrer">https://angular.io/docs/ts/latest/guide/template-syntax.html#ngFor</a>

`ngSwitch`: <a href="https://angular.io/docs/ts/latest/guide/template-syntax.html#ngSwitch" target="_blank" rel="noopener noreferrer">https://angular.io/docs/ts/latest/guide/template-syntax.html#ngSwitch</a>
