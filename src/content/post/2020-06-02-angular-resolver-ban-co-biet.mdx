...
Đây là github repo cho bài viết này nhé. Các bạn có thể clone về và trải nghiệm. -> <a href="https://github.com/tuananhitoct/angular-resolver" target="_blank" rel="noopener noreferrer"> Demo Resolver Angular</a>
  
## Link tham khảo
- <a href="https://angular.io/api/router/Resolve" target="_blank" rel="noopener noreferrer">{'https://angular.io/api/router/Resolve'}</a>  
- <a href="https://www.digitalocean.com/community/tutorials/angular-route-resolvers" target="_blank" rel="noopener noreferrer">{'https://www.digitalocean.com/community/tutorials/angular-route-resolvers'}</a>  
- <a href="https://codeburst.io/understanding-resolvers-in-angular-736e9db71267" target="_blank" rel="noopener noreferrer">{'https://codeburst.io/understanding-resolvers-in-angular-736e9db71267'}</a>  
- <a href="https://dzone.com/articles/understanding-angular-route-resolvers-by-example" target="_blank" rel="noopener noreferrer">{'https://dzone.com/articles/understanding-angular-route-resolvers-by-example'}</a>  
