...
Bạn có thể tham khảo thêm tại document sau: <a href="https://angular.io/guide/reactive-forms#!#async-vs-sync" target="_blank" rel="noopener noreferrer">{'https://angular.io/guide/reactive-forms#!#async-vs-sync'}</a>
...
Cũng giống như trong <a href="/thu-nghiem-voi-angular-template-driven-forms-trong-angular/">Template-driven forms</a>, chúng ta sẽ sử dụng một template giống thế.
...
Hoặc sử dụng <a href="https://github.com/angular/angular/blob/4.1.x/packages/forms/src/model.ts#L488" target="_blank" rel="noopener noreferrer">`hasError`</a>:
...
<Youtube id="SKwXZ_0Yk9I" />

## 12. Tham khảo

Reactive Forms documentation: <a href="https://angular.io/guide/reactive-forms" target="_blank" rel="noopener noreferrer">https://angular.io/guide/reactive-forms</a>

Git repo: <a href="https://github.com/tieppt/try-angular/tree/lesson-18" target="_blank" rel="noopener noreferrer">https://github.com/tieppt/try-angular/tree/lesson-18</a>
